...
const AboutMe = () => {
  return (
    <PostModel coverPhoto={coverPhoto} titulo="Sobre mim ......">
      <h3 className="subtitle">Olá, eu sou o Antônio Evaldo</h3>

      <img src={photoAboutMe} alt="vgvgvgk" className="aboutMePhoto" />
